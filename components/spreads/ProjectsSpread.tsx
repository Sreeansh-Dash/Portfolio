    ...
    <>
      ...
      <div className="flex-1 p-6 md:p-12 lg:p-16 flex flex-col relative border-b md:border-r md:border-b-0 border-gray-200 dark:border-gray-700/50">
        <header className="mb-12">
          ...
          <h1 className="font-display text-4xl lg:text-6xl text-primary dark:text-white font-black mb-4 tracking-tight">
            <SplitText text="Chapter III" delay={70} duration={0.4} />
          </h1>
          <h2 className="font-display text-2xl lg:text-3xl text-ink-light dark:text-gray-300 italic serif">
            <SplitText text="— Engineering & Systems" delay={60} duration={0.4} />
          </h2>
        </header>
      ...
      <div className="flex-1 p-8 md:p-12 lg:p-16 flex flex-col relative bg-paper-light dark:bg-paper-dark">
        ...
        {/* Fluttering Bookmark Ribbon */}
        <motion.div
          className="absolute top-0 right-6 w-10 h-24 bg-red-800 dark:bg-red-900 shadow-lg z-30 origin-top"
        ...
        <div className="h-full flex flex-col">
          <div className="flex justify-between items-baseline mb-10 border-b-2 border-primary/10 pb-4">
            <h3 className="font-display text-2xl font-bold text-ink-light dark:text-white">
              <SplitText text="Selected Works" delay={50} duration={0.4} />
            </h3>
