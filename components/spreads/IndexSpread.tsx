    ...
    <>
      ...
      <div className="flex-1 p-8 md:p-14 lg:p-20 flex flex-col relative border-b md:border-r md:border-b-0 border-gray-200 dark:border-gray-700/50 bg-page bg-paper-texture overflow-hidden">
        <header className="mb-12 flex-shrink-0">
          ...
          <h1 className="font-display text-5xl lg:text-6xl text-ink font-black mb-6 tracking-tight">
        ...
        <div className="flex-grow flex flex-col justify-start max-w-lg overflow-y-auto custom-scrollbar scroll-hint-container pr-2">
          <div className="space-y-8">
            ...
            <div className="font-serif text-lg md:text-xl text-ink leading-relaxed space-y-6">
              <p>
                <WrittenText 
        ...
        <div className="mt-auto pt-8 flex justify-between items-end text-xs tracking-widest text-muted font-bold uppercase flex-shrink-0" aria-hidden="true">
      ...
      <div className="flex-1 p-8 md:p-14 lg:p-20 flex flex-col relative bg-panel overflow-hidden">
        ...
        <div className="flex items-center gap-3.5 mb-10 opacity-80">
          <span className="material-icons text-3xl text-ink" aria-hidden="true">menu_book</span>
          <span className="font-display font-black text-xl tracking-wide text-ink uppercase">Contents</span>
        </div>

        <div className="mb-10 flex items-baseline justify-between border-b-2 border-gray-300 dark:border-gray-600 pb-5">
          <h2 className="font-display text-5xl md:text-6xl font-black text-ink">Index</h2>
              ...
              >
                <div className="flex items-baseline justify-between mb-1.5">
                  <div className="flex items-baseline gap-5">
                    ...
                    <span className="font-display font-black text-2xl text-ink group-hover:text-accent-warm transition-colors underline decoration-transparent group-hover:decoration-accent-warm/30 underline-offset-4">{item.label}</span>
                  </div>
