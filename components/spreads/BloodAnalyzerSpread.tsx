  ...
  return (
    <>
      ...
      <div className="flex-1 p-8 md:p-14 lg:p-20 flex flex-col relative bg-paper-light dark:bg-paper-dark overflow-hidden">
        ...
        <div className="flex-grow flex flex-col justify-start max-w-xl space-y-8 overflow-y-auto custom-scrollbar pr-2">
          ...
          >
            <div className="relative w-full max-w-sm h-full flex items-center justify-center">
              ...
              >
                ...
                <div className="text-center mt-2.5 font-mono text-[9px] text-gray-500 dark:text-gray-400 uppercase tracking-wider">
