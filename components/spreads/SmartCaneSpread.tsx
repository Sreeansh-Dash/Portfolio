      ...
      <div className="flex-1 p-8 md:p-14 lg:p-20 flex flex-col relative border-b md:border-r md:border-b-0 border-gray-200 dark:border-gray-700/50 bg-page bg-paper-texture overflow-hidden">
        ...
        <div className="flex-grow space-y-8 max-w-xl justify-start flex flex-col overflow-y-auto custom-scrollbar scroll-hint-container pr-2">
          ...
          <div className="font-serif text-base md:text-lg text-ink leading-relaxed">
            <h3 className="font-mono text-xs font-bold uppercase tracking-widest text-accent-warm mb-2.5">Key Decisions</h3>
            <ul className="list-disc list-outside pl-5 space-y-2 text-justify">
              ...
              <li><InteractiveWord text="Offline-first" hoverClass="font-bold text-ink" />: no cloud dependency, works in any environment</li>
            </ul>
          </div>
          ...
          <div className="mt-8 flex flex-col md:flex-row gap-8 text-sm">
            ...
            <div className="flex-grow">
              <h4 className="font-mono text-xs uppercase tracking-widest text-muted mb-2.5 border-b border-gray-200 dark:border-gray-800 pb-1">Contributors</h4>
              <div className="font-serif text-sm text-muted leading-normal">
            ...
            {/* Components */}
            <div className="flex-grow">
              <h4 className="font-mono text-xs uppercase tracking-widest text-muted mb-2.5 border-b border-gray-200 dark:border-gray-800 pb-1">Components</h4>
              <ul className="font-mono text-xs text-muted space-y-1 list-disc pl-4">
        ...
        <div className="flex-grow flex flex-col justify-start max-w-xl space-y-6 overflow-y-auto custom-scrollbar scroll-hint-container pr-2">
          ...
          <div className="relative my-6 group flex flex-col items-center">
            ...
            <div className="relative group/img cursor-pointer" onClick={() => setSelectedImage("/smartcane.png")} title="Click to enlarge">
              ...
              <div className="text-center mt-3 font-mono text-xs text-muted uppercase tracking-wider">
          ...
          {/* What I Learned */}
          <div>
            <h4 className="font-mono text-xs font-bold uppercase tracking-widest text-accent-warm mb-2">What I Learned</h4>
            <p className="font-serif text-sm md:text-base text-muted leading-relaxed text-justify">
          ...
          {/* Outcome Section */}
          <div className="pt-2">
            <h3 className="font-display text-sm font-bold text-muted uppercase tracking-widest mb-3 font-mono">
              Outcome Metrics
            </h3>
            <div className="grid grid-cols-2 gap-4">
              <div className="border border-stone-200 dark:border-stone-800 p-3 bg-stone-50/50 dark:bg-stone-900/30">
                <span className="block text-xl font-bold font-display text-ink mb-1">
                  Real-time
                </span>
